...
RAB_DATASET_BASE_PATH = '/mnt/data/guozhao/predatas/MSR-VTT/'
RAB_FEATURE_BASE_PATH = '/mnt/data/guozhao/features/MSR-VTT/ResNet_152/'
# the dir where all the experiment data is dumped.
RAB_EXP_PATH = '/home/lixiangpeng/workspace/videoCaption/code/results/v5_MSR-VTT/'
